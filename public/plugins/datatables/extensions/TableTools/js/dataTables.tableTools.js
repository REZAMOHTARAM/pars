...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // arzyabi event handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add arzyabi event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // arzyabi defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the arzyabi input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the arzyabi about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    arzyabi to let them know what the print view is.
	...
	/**
	 * Show a message to the end arzyabi which is nicely styled
	 *  @param {string} message The HTML string to show to the arzyabi
	...
	/**
	 * Take the arzyabi defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the arzyabi options */
		...
		// Backwards compatibility - allow the arzyabi to specify a custom class in the initialiser
	...
	/**
	 * Take the arzyabi input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of arzyabi defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end arzyabi but it allows the animation to be
		...
		if ( this.s.master )
		{
			...
			if ( this.s.select.type === 'os' ) {
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-arzyabi-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the arzyabi know what is happening */
		if ( oConfig.sInfo !== "" )
		{
