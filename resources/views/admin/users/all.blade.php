                ...
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex">
                        ...
                        <div class="btn-group-sm mr-1">
                            @can('create-users')
                                <a href="{{route('admin.users.create')}}" class="btn btn-warning">ایجاد کاربر جدید</a>
                            @endcan
                            <a href="{{ request()->fullUrlWithQuery(['admin' => 1]) }}" class="btn btn-danger">مدیران</a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <form action="{{route('admin.users.destroy' , ['user' => $user->id])}}" method="post">
                                            @csrf
                                            @method('delete')
                                            <button type="submit" class="btn  mr-1 btn-sm btn-danger ml-1">حذف</button>
                                        </form>
                                        @endcan
                                        @if($user->isStaffUser())
